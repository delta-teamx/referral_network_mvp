...
const en: Dict = {
  ...
  'hero.badge': 'Meet Referral Nova',
  'hero.titleA': 'The',
  'hero.titleHighlight': 'AI-powered',
  'hero.titleB': 'referral network for business owners',
...
const es: Dict = {
  ...
  'hero.badge': 'Conoce Referral Nova',
  'hero.titleA': 'La red de referidos',
  'hero.titleHighlight': 'con IA',
  'hero.titleB': 'para dueños de negocios',
...
const de: Dict = {
  ...
  'hero.badge': 'Willkommen bei Referral Nova',
  'hero.titleA': 'Das',
  'hero.titleHighlight': 'KI-gestützte',
  'hero.titleB': 'Empfehlungsnetzwerk für Unternehmer',
...
const fr: Dict = {
  ...
  'hero.badge': 'Découvrez Referral Nova',
  'hero.titleA': 'Le réseau de recommandation',
  'hero.titleHighlight': 'propulsé par l’IA',
  'hero.titleB': 'pour les entrepreneurs',
...
const pt: Dict = {
  ...
  'hero.badge': 'Conheça a Referral Nova',
  'hero.titleA': 'A rede de indicações',
  'hero.titleHighlight': 'com IA',
  'hero.titleB': 'para donos de negócios',
...
const ar: Dict = {
  ...
  'hero.badge': 'تعرّف على Referral Nova',
  'hero.titleA': 'شبكة الإحالات',
  'hero.titleHighlight': 'المدعومة بالذكاء الاصطناعي',
  'hero.titleB': 'لأصحاب الأعمال',

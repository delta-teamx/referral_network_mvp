...
const en: Dict = {
  ...
  'founding.bar': 'Founding offer - the first 200 businesses get lifetime Premium, free forever.',
  'founding.barSpots': 'Only {n} of {limit} spots left.',
  'founding.barCta': 'No credit card. Claim your spot →',
  'founding.cardTitle': 'Founding offer: the first 200 businesses get LIFETIME Premium - free forever',
  'founding.cardBody': 'Sign up now and keep full Premium access free for life - no payment, ever.',
...
const es: Dict = {
  ...
  'founding.bar': 'Oferta de lanzamiento: los primeros 200 negocios obtienen Premium de por vida, gratis para siempre.',
  'founding.barSpots': 'Solo quedan {n} de {limit} plazas.',
  'founding.barCta': 'Sin tarjeta. Reserva tu lugar →',
  'founding.cardTitle': 'Oferta de lanzamiento: los primeros 200 negocios obtienen Premium DE POR VIDA, gratis para siempre',
  'founding.cardBody': 'Regístrate ahora y conserva el acceso Premium completo gratis de por vida.',
...
const de: Dict = {
  ...
  'founding.bar': 'Gründungsangebot: Die ersten 200 Unternehmen erhalten Premium lebenslang kostenlos.',
  'founding.barSpots': 'Nur noch {n} von {limit} Plätzen frei.',
  'founding.barCta': 'Keine Kreditkarte. Sichern Sie sich Ihren Platz →',
  'founding.cardTitle': 'Gründungsangebot: Die ersten 200 Unternehmen erhalten LEBENSLANG Premium - für immer gratis',
  'founding.cardBody': 'Jetzt registrieren und vollen Premium-Zugang lebenslang kostenlos behalten.',
...
const fr: Dict = {
  ...
  'founding.bar': 'Offre de lancement : les 200 premières entreprises obtiennent Premium à vie, gratuitement.',
  'founding.barSpots': 'Plus que {n} places sur {limit}.',
  'founding.barCta': 'Sans carte bancaire. Réservez votre place →',
  'founding.cardTitle': 'Offre de lancement : les 200 premières entreprises obtiennent Premium À VIE, gratuit pour toujours',
  'founding.cardBody': 'Inscrivez-vous maintenant et gardez un accès Premium complet gratuit à vie.',
...
const pt: Dict = {
  ...
  'nav.logout': 'Sair',
  'common.language': 'Idioma',
  'founding.bar': 'Oferta de lançamento: as primeiras 200 empresas recebem Premium vitalício, grátis para sempre.',
  'founding.barSpots': 'Restam apenas {n} de {limit} vagas.',
  'founding.barCta': 'Sem cartão de crédito. Garanta sua vaga →',
  'founding.cardTitle': 'Oferta de lançamento: as primeiras 200 empresas recebem Premium VITALÍCIO, grátis para sempre',
  'founding.cardBody': 'Cadastre-se agora e mantenha acesso Premium completo grátis para sempre.',
...
const ar: Dict = {
  ...
  'founding.bar': 'عرض التأسيس: أول 200 شركة تحصل على بريميوم مدى الحياة، مجانًا للأبد.',
  'founding.barSpots': 'بقي {n} من {limit} مقعدًا فقط.',
  'founding.barCta': 'بدون بطاقة ائتمان. احجز مكانك →',
  'founding.cardTitle': 'عرض التأسيس: أول 200 شركة تحصل على بريميوم مدى الحياة مجانًا',
  'founding.cardBody': 'سجّل الآن واحتفظ بكامل صلاحيات بريميوم مجانًا مدى الحياة.',

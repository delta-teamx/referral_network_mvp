...
const en: Dict = {
  ...
  'hero.titleB': 'referral network for businesses',
...
const de: Dict = {
  ...
  'hero.titleB': 'Empfehlungsnetzwerk für Unternehmen',
...
const fr: Dict = {
  ...
  'hero.titleB': 'pour les entreprises',

...
const steps = [
  ...
  },
  {
    ...
    title: 'Book & Close',
    description:
      'Found a strong match? Send an intro request. Once accepted, book a Zoom call right inside NRG. After the call, log the outcome so the AI can learn and refine future matches.',
...
const faqs = [
  ...
  {
    q: 'Can I use NRG with my existing BNI or networking group?',
  ...
  },
  {
    ...
    a: 'LinkedIn is a broad social network. NRG is purpose-built for B2B referrals — every feature, from matching to scheduling, is designed to turn connections into revenue.',
  },
  {
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="mt-4 max-w-2xl text-gray-600">
            A match is just the beginning. Here is how NRG guides you from introduction to outcome.
          </motion.p>

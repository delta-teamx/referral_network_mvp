...
import { registerPushSubscribers } from './domains/core/notifications/push.subscribers.js';
import { pushRouter } from './domains/core/notifications/push.routes.js';
...
registerPushSubscribers(eventBus);
